...
'api_azsopti') THEN 1 WHEN GSP.source_type IN('api_yandex_other', 'api_rncard', 'api_ppr') THEN 2 ELSE 0 END AS Тип_ист
...
WHERE GSP.source_type IN('api_yandex_fuel', 'api_azsgo', 'api_benzuber', 'api_azsopti', 'api_yandex_other', 
